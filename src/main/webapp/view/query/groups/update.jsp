...
<script language="JavaScript">
    ...
    function showMenu() {
        ...
        $("#menuContent").css({left:nodeOffset.left + "px", top:nodeOffset.top + nodeName.outerHeight() + "px"}).slideDown("fast");
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <form action="${path }/groups/update.do" method="post" class="form-horizontal" role="form">
            <input type="hidden" id="groupId" name="groupId" value="${entity.groupId}">
            <input type="hidden" id="groupPid" name="groupPid" value="${entity.groupPid}">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input class="form-control" type="text" name="groupName" value="${entity.groupName}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="ds_username">展示节点</label>
                    <div class="col-sm-2">
                        <input type="radio" name="groupOpen" value="0" ${entity.groupOpen==0?"checked":""}>关闭
                        <input type="radio" name="groupOpen" value="1" ${entity.groupOpen==1?"checked":""}>开启
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="ds_username">节点顺序</label>
                    <div class="col-sm-2">
                        <input class="form-control" type="text" name="groupWeight" value="${entity.groupWeight}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="ds_username">节点等级</label>
                    <div class="col-sm-2">
                        <input class="form-control" type="text" name="groupLevel" value="${entity.groupLevel}"/>
                    </div>
                </div>
            </fieldset>
            <fieldset>
